...
<div data-header="sticky" data-header-top="200" data-canvas="container" class="l-theme animated-css">
    ...
    <div data-off-canvas="mobile-slidebar left overlay">
        <ul class="nav navbar-nav">
            <li><a href="/TI.WEB.SITE/" >Home</a></li>
            ...
            <nav id="nav" class="navbar">
                <div class="container">
                    <div class="header-navibox-1">
                        ...
                        <!-- Mobile Trigger End--><a href="home.html" class="navbar-brand scroll"><?= $this->Html->image('general/logo.png', ['alt' => 'logo', 'class' => 'normal-logo']) ?> <?= $this->Html->image('general/logo-dark.png', ['alt' => 'logo', 'class' => 'scroll-logo hidden-xs']) ?></a>
                    </div>
    ...
    <footer class="footer">
        ...
        <div class="footer__bottom">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="copyright pull-left">© 2022<strong> Raphael Tonelli, Monique Feitosa, Rafael Oliveira</strong> - Todos os direitos reservados.<a href="terms-of-use.html" class="copyright__link"> Terms of Use</a><a href="privacy-policy.html" class="copyright__link">Privacy Policy</a></div>
